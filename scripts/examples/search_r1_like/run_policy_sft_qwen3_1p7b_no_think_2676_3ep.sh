...
DATASET_BASENAME="mixed_second_search_1176_plus_qwen_naive_1000_plus_deepseek_one_search_500.no_think"
TIMESTAMP="${TIMESTAMP:-$(date +%Y%m%d_%H%M%S)}"
export EXPERIMENT_NAME="${EXPERIMENT_NAME:-qwen3_1p7b_policy_sft_no_think_2676_search_stop_mix_3ep_${TIMESTAMP}}"
