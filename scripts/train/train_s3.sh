...
PYTHONUNBUFFERED=1 python3 -m verl.trainer.main_ppo \
    ...
    max_turns=3 \
    recursive_call_mode=true \
    max_calls_per_episode=3 \
    tree_branching_factor=4 \
    tree_max_depth=2 \
    call_group_strategy=per_call \
    use_llm_relevance_score=true \
    # relevance_score_url="http://127.0.0.1:8001/score" \
    # relevance_score_timeout=10.0 \
