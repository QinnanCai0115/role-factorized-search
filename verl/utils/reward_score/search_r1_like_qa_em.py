...
def compute_score(solution_str, ground_truth, method="strict", format_score=0.0, score=1.0):
    ...
    if do_print:
        print("--------------------------------")
        target = ground_truth.get('target', 'N/A') if isinstance(ground_truth, dict) else 'N/A'
    ...
    if answer is None:
        ...
        target = ground_truth.get("target", None) if isinstance(ground_truth, dict) else None
        if target is None:
            return 0
